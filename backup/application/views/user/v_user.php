                    ...
                    <table class="table table-striped table-md">
                        <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td><?= anchor('User/edit/' .$row->user_id , '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>')  ?></td>
	                            <td onclick="javascript: return confirm('Anda Yakin Mau Menghapus')"><?= anchor('User/delete/' .$row->user_id ,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>  
	                        </tr>
                        	<?php endforeach ?>
                      	</tbody>
                    </table>
