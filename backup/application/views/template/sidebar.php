          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?= base_url('Property') ?>">Property</a></li>
                  <li><a class="nav-link" href="<?= base_url('Room') ?>">Room</a></li>
                  <li><a class="nav-link" href="<?= base_url('Navigate_button') ?>">Navigate Button</a></li>
